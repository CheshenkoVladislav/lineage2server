...
public final class Config
{
	...
	private static final void loadServer()
	{
		...
		DATABASE_URL = server.getProperty("URL", "jdbc:mysql://localhost/firstl2database");
		DATABASE_LOGIN = server.getProperty("Login", "cheshenko");
		DATABASE_PASSWORD = server.getProperty("Password", "cheshvlad");
